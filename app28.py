...
app.config['MYSQL_USER'] = 'Qz4b0I89qY'
app.config['MYSQL_PASSWORD'] = 'BlNHfH6N6H'
app.config['MYSQL_DB'] = 'Qz4b0I89qY'
mysql = MySQL(app)
...
app.config['MAIL_USERNAME'] = 'namithagn5@gmail.com'#put your eamil account
app.config['MAIL_PASSWORD'] = '8880998899' #put your email password
...
def sendmail():
    if request.method == 'POST':
        ...
        msg = Message('Hello', sender='namithagn5@gmail.com',recipients=[rec])
